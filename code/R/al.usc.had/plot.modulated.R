...
### PAMAP
#l.al.file.name = '~/R/sf_ALTLAR/output/al.usc.had.modulated/pamap/l.al.unif.size.200.frame.Rdata'
#l.al.file.name = '~/R/sf_ALTLAR/output/al.usc.had.modulated/pamap/l.al.unif.size.150.frame.Rdata'
#l.al.file.name = '~/R/sf_ALTLAR/output/al.usc.had.modulated/pamap/l.al.unif.size.100.frame.Rdata'
#l.al.file.name = '~/R/sf_ALTLAR/output/al.usc.had.modulated/pamap/l.al.unif.size.50.frame.Rdata'
#l.al.file.name = '~/R/sf_ALTLAR/output/al.usc.had.modulated/pamap/l.al.exp.lambda.1.frame.Rdata'
#l.al.file.name = '~/R/sf_ALTLAR/output/al.usc.had.modulated/pamap/l.al.exp.lambda.2.frame.Rdata'
...
#l.al.file.name = '~/R/sf_ALTLAR/output/al.usc.had.modulated/usc-had/l.al.unif.size.150.frame.Rdata'
#l.al.file.name = '~/R/sf_ALTLAR/output/al.usc.had.modulated/usc-had/l.al.unif.size.100.frame.Rdata'
#l.al.file.name = '~/R/sf_ALTLAR/output/al.usc.had.modulated/usc-had/l.al.unif.size.50.frame.Rdata'
#l.al.file.name = '~/R/sf_ALTLAR/output/al.usc.had.modulated/usc-had/retry/l.al.exp.lambda.1.frame.Rdata'
#l.al.file.name = '~/R/sf_ALTLAR/output/al.usc.had.modulated/usc-had/retry/l.al.exp.lambda.2.frame.Rdata'
#l.al.file.name = '~/R/sf_ALTLAR/output/al.usc.had.modulated/usc-had/retry/l.al.exp.lambda.3.frame.Rdata'
...
size = NA
if ('unif' %in% tokens) {
  i.size = which(regexpr(pattern='[0-9]+', text=tokens) >= 0)
...
if ('exp' %in% tokens) {
  ...
  lambda = as.integer(tokens[i.lambda])
